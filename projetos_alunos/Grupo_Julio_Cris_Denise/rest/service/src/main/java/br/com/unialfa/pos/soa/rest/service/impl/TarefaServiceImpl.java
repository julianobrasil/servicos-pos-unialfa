...
public class TarefaServiceImpl implements TarefaService {
	...
	@Override
	public Page<UsuarioTarefa> obtemTodasAsAlocacoes(Long idTarefaSelecionada, Pageable pageable) {
		return this.usuarioTarefaRepository.findByTarefaIdOrderByUsuarioNome(idTarefaSelecionada, pageable);
	}
	...
	@Override
	public List<Usuario> listaUsuariosPorTarefa(Long idtarefa) {
		return this.usuarioTarefaRepository.findUsuariosByTarefaId(idtarefa);
	}
